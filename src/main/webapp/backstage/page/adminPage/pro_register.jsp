...
<body>
    <!-- 表头 -->
    <div id="h1" style="margin-left: 20px;margin-top: 10px"><h1  style="color: slategrey">省疾控中心人员注册</h1></div>
    <br />
    <hr />
    ...
    <script>
        layui.use(['form', 'jquery', 'table', 'layer', 'util','laydate'], function() {
            ...
            form.on("submit(*)", function (d) {
                $.post("/adminServlet?method=register&identity=pro_user", d.field, function (rs) {
                    //业务正常
                    if (rs.code == 200) {
                        console.log(rs)
                        layer.msg("注册成功");
                        window.location.href = "${pageContext.request.contextPath}/backstage/page/pro_registerSuccess.jsp";
